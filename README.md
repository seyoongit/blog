...
[그냥 알파벳 옮기는 사이트](http://github.com/seyoongit/jma) 를 배포할때 파이어베이스는 이미 사용해봐서 새로운걸 시도할겸 S3 hosting 랑 heroku에 접근했는데 둘다 도메인을 깔끔하게 연결할 방도가 없어서 결국 헛수고만 잔뜩하고 결국 파이어베이스로 돌아오게 되었다. <br>
개인적으로 정말 고마운 서비스고 극찬을 하지 않을수가 없다. <br>
